...
/*    public TaskSecondSendAnOrder GoToMenuRoll() {
    ...
    public TaskSecondSendAnOrder MathRandomHead (){
        List<WebElement> list = driver.findElements(By.xpath("//a[contains(@class, \"scroll-nav_link\") and not (contains(@href, \"/menu/napitki\")) and not (contains(@href, \"/menu/deserty\")) and not (contains(@href, \"/menu/drugie-tovary\")) ]"));
